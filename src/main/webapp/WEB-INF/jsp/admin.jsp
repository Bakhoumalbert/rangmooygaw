...
<div class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <ul>
            <li><a href="/admin/clients" class="menu-item" id="clientsLink">Clients</a></li>
            <li><a href="/admin/services" class="menu-item" id="servicesLink">Services</a></li>
            <li><a href="/admin/agences" class="menu-item" id="agencesLink">Agences</a></li>
            <li><a href="/admin/agents" class="menu-item" id="agentsLink">Agents</a></li>
            <li><a href="/admin/logout" class="menu-item" id="logoutLink">Déconnexion</a></li>
        </ul>
    </div>
    <!-- Sidebar Toggle Button -->
</div>
